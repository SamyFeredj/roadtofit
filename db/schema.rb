...
ActiveRecord::Schema[7.1].define(version: 2025_03_22_152210) do
  ...
  create_table "recettes", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "nom"
    t.integer "temps_de_preparation"
    t.integer "note_globale"
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.integer "age"
    t.string "sexe"
    t.string "objectif_physique"
    t.integer "objectif_calorique"
    t.string "regimes_alimentaires"
